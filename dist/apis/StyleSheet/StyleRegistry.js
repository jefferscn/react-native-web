...
rdomClassList=domStyleProps.classList;var rdomStyle=domStyleProps.style;var _rdomClassList$reduce=



rdomClassList.reduce(
function(styleProps,className){var _styleManager$getDecl2=
_this2.styleManager.getDeclaration(className);var prop=_styleManager$getDecl2.prop;var value=_styleManager$getDecl2.value;
if(prop){
...
{classList:[],style:{}});var rnClassList=_rdomClassList$reduce.classList;var rnStyle=_rdomClassList$reduce.style;var _resolve=



this.resolve(
[rnStyle,rnStyleNext],
options);var rdomClassListNext=_resolve.classList;var rdomStyleNext=_resolve.style;



var style=_extends({},rdomStyle);
rdomClassListNext.forEach(function(className){var _styleManager$getDecl=
_this2.styleManager.getDeclaration(className);var prop=_styleManager$getDecl.prop;
if(style[prop]){
style[prop]='';
}
});
